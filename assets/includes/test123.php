...
//$path = plugin_dir_url(__FILE__)."as"
...
$accessKey = '';
$accessSecret = '';
//$accessKey = 'Agy25MJTEbLFafDAyv1qZP35';
//$accessSecret = 'Os2QiFbdPEsKNsJDkV7ZTtaPa9ly7jsAikPhWSIc';

// Step 2: load this PHP file in a web browser, and follow the instructions to set
// the following variables:
//$accessKey = 'Aga1y0EdGKh0zjkVrR1sgoJS';
//$accessSecret = 'cUKqqgm1MTosrMOomADorhFEQQqUAHUQC194rb7o';
//$list_id = '';
//$list_id = '3160788'; // list name:default3160788
//$list_id = '3163342'; // list name:default3163342
